...
// import { CreateContent } from "./components/ui/AddContent"
import { Card } from "./components/ui/Card"
import { useState } from "react"
import { ShareBrain } from "./components/ui/ShareContent"
...
function App() {
  ...
  return (
    <div className="bg-gray-200 h-auto p-4">
      <ShareBrain onShare={onShare} onUpdate={() => setShare(!onShare)}/>
      {/* <CreateContent open={modalOpen} onClose={() => {setModalOpen(!modalOpen)} }/> */}
      ...
      <Button startIcon={<ShareIcon />} variant="secondary" text="Share Brain" size="md" onClick={() => {setShare(!onShare)}}/>
      <Button startIcon={<PlusIcon />} variant="primary" text="Add Content" size="md" onClick={() => {setModalOpen(!modalOpen)}}/>
    </div>
  )
}
